...
from postgwas.core.execution.runtime import auto_detect_workers, validate_path, validate_alphanumeric
...
def add_common_options(parser: argparse.ArgumentParser):
    ...
    model_group.add_argument(
        ...
        default=str(Path(__file__).resolve().parent.parent / "resources" / "model"),
