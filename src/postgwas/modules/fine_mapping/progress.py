...
from postgwas.modules.fine_mapping.defaults import PROGRESS_DECIMAL_PLACES
...
def progress_values(completed, total, decimal_places=PROGRESS_DECIMAL_PLACES):
...
class ProgressRecorder:
    ...
    def __init__(
        ...
        logger=None,
        overwrite=True,
        decimal_places=PROGRESS_DECIMAL_PLACES,
    ):
        self.progress_file = Path(progress_file)
        self.progress_file.parent.mkdir(parents=True, exist_ok=True)
        self.logger = logger or logging.getLogger("postgwas.modules.fine_mapping")
