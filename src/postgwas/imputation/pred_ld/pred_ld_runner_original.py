...
def run_pred_ld_parallel(
    ...
    ref: str = "TOP_LD",
    threads: int = 6,
    pred_ld="/Users/JJOHN41/Documents/developing_software/postgwas/src/postgwas/imputation/pred_ld/pred_ld.py"
):
    """
    ...
    pred_ld_ref = os.path.abspath(pred_ld_ref)
    os.makedirs(output_folder, exist_ok=True)
    
    def process_chrom(chrom):
        #print(f"🧬 Starting chromosome {chrom}...")
        chr_output = Path(predld_input_dir) / f"{output_prefix}_chr{chrom}_predld_input.tsv"
